(function seedData(){
 ...
 const defaultSettings={storeName:"HERITAGE THREAD",whatsappPhone:"09016654210",adminEmail:adminEmail};
...
function applyStoreBrand(){const s=getSettings();document.querySelectorAll('[data-store-name]').forEach(el=>el.textContent=s.storeName||'HERITAGE THREAD')}
